...
public class JavaMailUtil {
    ...
    /**
     * 发送邮件，通过qq邮件发送，因为具有ssl加密，采用的是smtp协议
     * @param mailHost 邮件服务器的主机名 "smtp.qq.com"
	 * @param loginAccount 登录邮箱的账号 "xxxxxxxx@qq.com"
     ...
     */
    public static boolean sendEmail(String mailHost, final String loginAccount, final String loginAuthCode,
    ...
    public static boolean sendEmail(String mailHost, final String loginAccount, final String loginAuthCode,
        ...
        return JavaMailUtil.sendEmail(mailHost, loginAccount, loginAuthCode, name, recipientsTemp, mailSubject, mailContent);
    }

    public static boolean sendEmail(String mailHost, final String loginAccount, final String loginAuthCode,
                                    String[] recipients, String mailSubject, String mailContent){
        return JavaMailUtil.sendEmail(mailHost, loginAccount, loginAuthCode, null, recipients, mailSubject, mailContent);
    }
